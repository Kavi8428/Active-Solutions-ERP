...
// Check if the 'item_code' parameter exists in the URL
if (isset($_GET['item_code'])) {
    ...
    if ($result) {
        ...
        $query = "SELECT * FROM pricing WHERE item_code = '$item_code'";
        $result = mysqli_query($conn, $query);
            ...
            if ($result) {
                ...
                if ($row5) {
                    // Now you can use $row to display the product details in your HTML
                }}
...
if (isset($_GET['item_code'])) {  
    ...
    $item_code = $_GET['item_code'];
        ...
        $query = "SELECT * FROM product_synology WHERE item_code = '$item_code'";
        $result = mysqli_query($conn, $query);
                                ...
                                <div class="row">
                                    <div class="col-xl-5 col-lg-6 text-center">
                                        <img class="w-100 border-radius-lg shadow-lg mx-auto"
                                            src="<?php echo $row['image1']; ?>" alt="chair">
                                        <div class="my-gallery d-flex mt-4 pt-2" itemscope
                                            itemtype="http://schema.org/ImageGallery">
                                            <figure itemprop="associatedMedia" itemscope
                                                itemtype="http://schema.org/ImageObject">
                                                <h6>Long Description</h6>
                                                <label class="ms-0"><?php echo $row['long_des']; ?></label>
                                    ...
                                    <div class="col-lg-5 mx-auto">
                                        <h3 class="mt-lg-0 mt-2"><?php echo $row['item_code']; ?></h3>

                                        <div class="row">
    <h4 class="mb-0 mt-3"> Price</h4>
    
    <div class="col-3">
        <label class="mb-0 mt-3"> Re-Seller</label>
        <?php if(isset($row5['r']) && !empty($row5['r'])): ?>
            <h5><?php echo $row5['r']; ?></h5>
        <?php endif; ?>
    </div>
    
    <div class="col-3">
        <label class="mb-0 mt-3">L Re-Seller</label>
        <?php if(isset($row5['lr']) && !empty($row5['lr'])): ?>
            <h5><?php echo $row5['lr']; ?></h5>
        <?php endif; ?>
    </div>
    
    <div class="col-3">
        <label class="mb-0 mt-3">Retailer</label>
        <?php if(isset($row5['rt']) && !empty($row5['rt'])): ?>
            <h5><?php echo $row5['rt']; ?></h5>
        <?php endif; ?>
    </div>
    
    <div class="col-3">
        <label class="mb-0 mt-3">Cost</label>
        <?php if(isset($row5['cost']) && !empty($row5['cost'])): ?>
            <h5><?php echo $row5['cost']; ?></h5>
        <?php endif; ?>
    </div>
</div>


                                        <label class="mt-4"> <b>Description</b> </label><br>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                ...
                                                <label class="ms-0"><?php echo $row['category']; ?></label>
                                            </div>
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                <label><b>Brand</b></label><br>
                                                <label class="ms-0"><?php echo $row['brand']; ?></label>

                                            </div>
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                <label><b>Manufacture</b></label><br>
                                                <label class="ms-0"><?php echo $row['manufacturer']; ?></label>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                <label><b>CPU Model</b></label><br>
                                                <label class="ms-0"><?php echo $row2['cpuModel']; ?></label>
                                            </div>
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                <label><b>CPU Quentity</b></label><br>
                                                <label class="ms-0"><?php echo $row2['cpuQt'];?></label>

                                            </div>
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                <label><b>CPU Frequency</b></label><br>
                                                <label class="ms-0"><?php echo $row2['cpuFrequency']; ?></label>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                <label><b>CPU Architecture</b></label><br>
                                                <label class="ms-0"><?php echo $row2['cpuArchitecture']; ?></label>
                                            </div>
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                <label><b>Total Memory Slots</b></label><br>
                                                <label class="ms-0"><?php echo $row2['totalMemorySlot'];?></label>

                                            </div>
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                <label><b>Memory module</b></label><br>
                                                <label class="ms-0"><?php echo $row2['memoryModule']; ?></label>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                <label><b>Maximum Memory Capacity</b></label><br>
                                                <label
                                                    class="ms-0"><?php echo $row2['maximumMemoryCapacity']; ?></label>

                                            </div>
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                <label><b>System Memory</b></label><br>
                                                <label class="ms-0"><?php echo $row2['systemMemory']; ?></label>

                                            </div>
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                <label><b>Compatible Drive Type</b></label><br>
                                                <label class="ms-0"><?php if($row2['compatibleDriveType'] == '1') {echo 'SAS' ; } else{echo 'SATA';}?></label>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                <label><b>Maximum Expantion Units</b></label><br>
                                                <label
                                                    class="ms-0"><?php echo $row2['maximumExpansionUnits']; ?></label>

                                            </div>
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                <label><b>Slots</b></label><br>
                                                <label class="ms-0"><?php echo $row2['driveSlots']; ?></label>

                                            </div>
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                <label><b>E-Sata Port</b></label><br>
                                                <label class="ms-0"><?php echo $row2['eSataPort']; ?></label>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                <label><b>RJ_45_1GbE Port</b></label><br>
                                                <label class="ms-0"><?php echo $row2['RJ_45_1GbE']; ?></label>

                                            </div>
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                <label><b>RJ_45_10GbE Port</b></label><br>
                                                <label class="ms-0"><?php echo $row2['RJ_45_10GbE']; ?></label>

                                            </div>
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                <label><b>RJ_45_25GbEt Port</b></label><br>
                                                <label class="ms-0"><?php echo $row2['RJ_45_25GbEt']; ?></label>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-6 mt-lg-0 mt-2">
                                                <label><b>Max Bays With Expantion Unit</b></label><br>
                                                <label class="ms-0"><?php echo $row2['maxBayWithExpanUnit']; ?></label>

                                            </div>
                                            <div class="col-lg-6 mt-lg-0 mt-2">
                                                <label><b>Max Local User Accounts</b></label><br>
                                                <label
                                                    class="ms-0"><?php echo $row2['MaximumLocalUserAccounts']; ?></label>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-6 mt-lg-0 mt-2">
                                                <label><b>Max Concurrent Connections</b></label><br>
                                                <label
                                                    class="ms-0"><?php echo $row2['maximumConcurrentConnection']; ?></label>

                                            </div>
                                            <div class="col-lg-6 mt-lg-0 mt-2">
                                                <label><b>Max Concurrent Connections with Ram</b></label><br>
                                                <label
                                                    class="ms-0"><?php echo $row2['maximumConcurrentConnectionWithRam']; ?></label>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-6 mt-lg-0 mt-2">
                                                <label><b>USB Port</b></label><br>
                                                <label class="ms-0"><?php echo $row2['usbPort']; ?></label>

                                            </div>
                                            <div class="col-lg-6 mt-lg-0 mt-2">
                                                <label><b>USB Copy</b></label><br>
                                                <label class="ms-0"><?php echo $row2['usbCopy']; ?></label>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                <label><b>Sys Log Event Per Second</b></label><br>
                                                <label class="ms-0"><?php echo $row2['sysLogEventPerSecond']; ?></label>

                                            </div>
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                <label><b>Maximum Ip Cam</b></label><br>
                                                <label class="ms-0"><?php echo $row2['maximumIpCam']; ?></label>

                                            </div>
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                <label><b>Read Write Cashe</b></label><br>
                                                <label class="ms-0"><?php echo $row2['readWriteCashe']; ?></label>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-4 mt-lg-0 mt-2">
                                                <label><b>High Availabilty</b></label><br>
                                                <label class="ms-0"><?php echo $row2['highAvailabilty']; ?></label>
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input"
                                                                ...
                                                                <?php  if($row3['ext4'] == 'EXT4'){echo 'checked';}else{echo 'disabled';}?>>
                                                    ...
                                                    <div class="col-3">
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input"
                                                                ...
                                                                <?php  if($row3['btrfs'] == 'Btrfs'){echo 'checked';}else{echo 'disabled';}?>>
                                                            <label class="form-check-label"
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-lg-5">
                                            <a href="edit_product_synology.php?item_code=<?php echo urlencode($row['item_code']); ?>"
                                                target="_blank" rel="noopener noreferrer">
                                                <button class="btn bg-dark mb-0 mt-lg-auto w-100" type="button"
