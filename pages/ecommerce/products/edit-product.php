...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (!empty($_POST["token"]) && hash_equals($_SESSION["token"], $_POST["token"])) {
      ...
      $stmt->bind_param("ssssssssss", $manufacturer, $short_des, $long_des, $category, $image1Path, $image2Path, $brand, $capacity, $warrenty , $item_code);
        ...
        <div class="container-fluid py-4">
            <form class="multisteps-form__form" method="POST" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-lg-11 text-color-white d-flex flex-column justify-content-center">
                        <button type="submit"
                            class="btn bg-dark mb-0 ms-lg-auto me-lg-0 me-auto mt-lg-0 mt-2">Save</button>
                    </div>
                </div>
                <div class="row mt-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-4">
                                    <div class="col-3">
                                        <div class="input-group input-group-dynamic">
                                            ...
                                            <input name="item_code" type="text" class="form-control w-100"
                                    ...
                                    <div class="col-3 mt-3 mt-sm-0">
                                        <div class="input-group input-group-dynamic">
                                            ...
                                            <input name="manufacturer" type="text" class="form-control w-100"
                                                onfocus="focused(this)" onfocusout="defocused(this)"
                                    ...
                                    <div class="col-3">
                                        <div class="input-group input-group-dynamic">
                                            ...
                                            <input name="capacity" type="text" class="form-control w-100"
                                                onfocus="focused(this)" onfocusout="defocused(this)"
                                                value="<?php echo $capacity; ?> TB">
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="input-group input-group-dynamic">
                                            <label class="form-label">Warrenty</label>
                                            <input name="warrenty" type="text" class="form-control w-100"
                                                onfocus="focused(this)" onfocusout="defocused(this)"
                                                value="<?php echo $warrenty; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-4">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div >
                                            <textarea type="text" name="short_des"
                                                class="form-control border-1 "
                                                ><?php echo $short_des; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <label class="ms-0">Brand</label>
                                        <?php
                                                                $sql = "SELECT brand FROM brand";
                                                                $result = mysqli_query($conn, $sql);
                                                                if ($result) {
                                                                    
                                                                    echo '<select class="form-control" name="choices-category" id="choices-category-edit" required >';
                                                                    echo '<option value="'.$brand.'" selected=""></option>';
                                    ...
                                    <div class="col-3">
                                        ...
                                        <?php
                                            ...
                                            $result = mysqli_query($conn, $sql);
                                            if ($result) {
                                                echo '<select class="form-control"  name="choices-color" id="choices-color-edit" required >';
                                ...
                                <div class="row">
                                   <div class="col-6">
                                    <label class="font-weight-bolder mb-3">Long Description</label>

                                        <textarea type="text" name="long_des"
                                        class="form-control border-1"
                                ...
                                <div class="input-group input-group-dynamic mt-3">
                                    <input name="image1" type="file" class="form-control w-100" onfocus="focused(this)"
                                        onfocusout="defocused(this)" placeholder="Image1"
                                        value="<?php echo $image1; ?>">
                                </div>

                                <div class="input-group input-group-dynamic">
                                    <input name="image2" type="file" class="form-control w-100" onfocus="focused(this)"
                                        onfocusout="defocused(this)" value="<?php echo $image2; ?>">
                                </div>
                                   </div>
