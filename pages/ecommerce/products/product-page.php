                                    ...
                                    <div class="col-lg-5 mx-auto">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                ...
                                                <h5><?php echo $row1['r']; ?></h5>
                                            </div>
                                            <div class="col-3">
                                                <label class="mb-0 mt-3">L Re-Seller</label>
                                                <h5><?php echo $row1['lr']; ?></h5>
                                            </div>
                                            <div class="col-3">
                                                <label class="mb-0 mt-3">Retailer</label>
                                                <h5><?php echo $row1['rt']; ?></h5>
                                            </div>
                                            <div class="col-3">
                                                <label class="mb-0 mt-3">Cost</label>
                                                <h5><?php echo $row1['cost']; ?></h5>
                                            </div>
                                        </div>

                                        <!--<span class="badge badge-success">In Stock</span>-->

                                        <label class="mt-4">Description</label><br>
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-lg-5">
                                                    <a href="edit-product.php?item_code=<?php echo urlencode($row['item_code']) ; ?>"
