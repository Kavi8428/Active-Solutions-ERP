...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO product (item_code, manufacturer, short_des, long_des, category, image1, image2, brand) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";

    // Prepare the SQL statement
    $stmt = $conn->prepare($sql);

    // Bind parameters (including image paths) to the SQL statement
    $stmt->bind_param("ssssssss", $itemCode, $manufacturer, $shortDescription, $longDescription, $category, $img1Path, $img2Path, $brand);

    try {
        if ($stmt->execute()) {
                $sqlPrice = "INSERT INTO pricing (item_code, lr, r, rt, cost) VALUES (?, ?, ?, ?, ?)";

                // Prepare the SQL statement
                $stmtPrice = $conn->prepare($sqlPrice);

                // Bind parameters (including image paths) to the SQL statement
                $stmtPrice->bind_param("sdddd", $itemCode, $lr, $r, $rt, $cost);
                ...
                try {
                    ...
                    echo '<script>alert("Somthing wrong. please contact the developer.")</script>';
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">BD Com</h6>
                </nav>
                            ...
                            <div class="bg-dark  shadow-dark border-radius-lg pt-4 pb-3">
                                <div class="multisteps-form__progress">
                                    ...
                                    <button class="multisteps-form__progress-btn" type="button" title="Pricing">4.
                                        Pricing</button>
                                    <button class="multisteps-form__progress-btn" type="button" title="Pricing">5.
                                        Specs</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <form class="multisteps-form__form" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 mt-sm-3 mt-5">
                                                ...
                                                include '../../../connection.php';
                                                 ...
                                                 generateCategoryDropdown($conn, 'choices-category', 'choices-category', true);
                                                ?>
                                                <label class="form-control ms-0">Brand</label>
                                                <input class="multisteps-form__input form-control" type="text"
                                                    name="bd_com" value="BD Com" />
                                ...
                                <div class="multisteps-form__panel pt-6 border-radius-xl bg-white h-100"
                                    ...
                                    <div class="multisteps-form__content mt-2">
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-6">
                                                <div class="input-group input-group-dynamic">
                                                    ...
                                                    <label class="form-label">Re-Seller</label>
                                                    <input class="multisteps-form__input form-control" type="text"
                                                        name="r" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-6">
                                                <div class="input-group input-group-dynamic">
                                                    ...
                                                    <label class="form-label">Low Re-Seller</label>
                                                    <input class="multisteps-form__input form-control" type="text"
                                                        name="lr" />
                                                </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="button-row d-flex mt-0 mt-md-auto">
                                                <button class="btn bg-gradient-light mb-0 js-btn-prev" type="button"
                                                    title="Prev">Prev</button>
                                ...
                                <div class="multisteps-form__panel pt-2 border-radius-xl bg-white h-100"
                                    data-animation="FadeIn">
                                    <h5 class="font-weight-bolder">Specifications</h5>
                                    <div class="multisteps-form__content">
                                        <div class="row mt-2">
                                            <div class="col-2">
                                                <div class="input-group input-group-dynamic">
                                            ...
                                            <div class="col-10">
                                                <div class="input-group input-group-dynamic">
                                                    <select style="border: none;" class="form-label content-center"
                                                        name="capacity" id="choices-questions" required>
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-2">
                                                <div class="input-group input-group-dynamic">
                                                    <label class="form-label">POE Port :</label>
                                                </div>
                                            </div>
                                            <div class="col-2">
                                                <div class="input-group input-group-dynamic">
                                            ...
                                            <div class="col-1">
                                                <div class="input-group input-group-dynamic">
                                                    <select style="border: none;" class="form-label content-center"
                                                        name="port" id="choices-questions" required>
                                            ...
                                            <div class="col-7">
                                                <div class="input-group input-group-dynamic">
                                                    <select style="border: none;" class="form-label content-center"
                                                        name="speed" id="choices-questions" required>
                                                        <option value="10/100">&nbsp;10/100</option>
                                                        <option value="10/100/1000">&nbsp;10/100/1000</option>
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-2">
                                                <div class="input-group input-group-dynamic">
                                                    <label class="form-label">MAC Capacity :</label>
                                                </div>
                                            </div>
                                            <div class="col-10">
                                                <div class="input-group input-group-dynamic">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="ram" id="1k"
                                                            value="Ram">
                                                        <label class="form-check-label" for="1k">1K</label>
                                                    </div>
                                                    <label class="form-label"></label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="ram" id="2k"
                                                            value="Max Ram" checked>
                                                        <label class="form-check-label" for="2k">2K</label>
                                                    </div>
                                                    <label class="form-label"></label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="ram" id="8k"
                                                            value="Ram">
                                                        <label class="form-check-label" for="8k">8K</label>
                                                    </div>
                                                    <label class="form-label"></label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="ram" id="16k"
                                                            value="Max Ram" checked>
                                                        <label class="form-check-label" for="16k">16K</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="button-row d-flex mt-1 mt-md-5">
                                            <button class="btn bg-gradient-light mb-0 js-btn-prev" type="button"
                                                title="Prev">Prev</button>
                                            <button class="btn bg-gradient-dark ms-auto mb-0" type="submit"
                                                title="Send">Send</button>
