...
// Retrieve data from the form and use a regular expression to allow alphanumeric characters and symbols like '-'
    ...
    $sqlprice = "INSERT INTO pricing (item_code, lr, r, rt, cost) VALUES ('$item_code', '$lr', '$r', '$rt', '$cost')";
    
    if ($conn->query($sqlprice) === TRUE) {
        echo "<script>alert('Price inserted successfully')</script>";
    } else {
    ...
    $warrenty = isset($_POST["warrenty"]) ? $_POST["warrenty"] : 0;
    $img1 = isset( $_POST["img1"]) ?  $_POST["img1"]: 0;
    $img2 = isset($_POST["img2"]) ? $_POST["img2"] : 0;
    ...
    $sql = "INSERT INTO product (item_code, manufacturer, short_des, long_des, category, image1, image2, brand,  capacity, warrenty) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

    // Prepare the SQL statement
    $stmt = $conn->prepare($sql);

    // Bind parameters (including image paths) to the SQL statement
    $stmt->bind_param("ssssssssds", $itemCode, $manufacturer, $shortDescription, $longDescription, $category, $img1Path, $img2Path, $brand,$capacity, $warrenty);
                ...
                if ($mergeStmt->execute()) {
                    ...
                    $user = $_SESSION['user'];
                        ...
                        $logStmt->close();
                            ...
                            echo '<script>alert("Log is not created")</script>';
                            
                        }
                }
                else{
                    echo '<script>alert("merge is not created")</script>';
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page"> <a href="../../ecommerce/products/products-list.php" class="link">Products</a> </li>
                    </ol>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="multisteps-form__form" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="multisteps-form__panel pt-3 border-radius-xl bg-white js-active"
                                    ...
                                    <div class="multisteps-form__content">
                                                ...
                                                <div class="multisteps-form__content">
                                                    <div class="row mt-3">
                                                        <textarea name="short_desc"
                                                            style="width: 650px; height: 200px; padding: 10px; font-size: 16px; border: 1px solid #ccc;"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 mt-sm-3 mt-3">
                                        ...
                                        <div class="col-6 col-sm-6">
                                                <div class="input-group input-group-dynamic">
                                                    <label for="exampleFormControlInput1" class="form-label">Warrenty</label>
                                                    <input class="multisteps-form__input form-control" type="text"
                                                        name="warrenty" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="button-row d-flex mt-4">
                                            <a href="../../ecommerce/products/synology.php"
                                                class="btn bg-gradient-light ms-2 mb-0" type="button" title="Next">If
                                                NAS</a>
                                            <a href="../products/bdcom.php" class="btn bg-gradient-light ms-2 mb-0"
                                ...
                                <!--single form panel-->
                                <div class="multisteps-form__panel pt-4 border-radius-xl bg-white h-100"
                                    data-animation="FadeIn">
