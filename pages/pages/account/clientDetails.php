...
$query = "SELECT customer_id, company_name, address, type, credit_limit, payment_terms, note FROM customer";
            ...
            <div class="row">
                <div class="row">
                    ...
                    <div class="col-1">
                        ...
                        <a href="../account/newClient.php"><button class="btn btn-dark">New</button></a>
            ...
            <div class="row my-4">
                <div class="col-12">
                  ...
                  while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<td>' . $row['note'] . '</td>';
                    echo '<td>';
                    echo '<a href="../account/selectedCEDetails.php"><button class="btn">EMP</button></a>';
                    echo '<a href="edit_client.php?customer_id=' . $row['customer_id'] . '" data-bs-toggle="tooltip" data-bs-original-title="Edit product">';
