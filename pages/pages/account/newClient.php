...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO customer (company_name, address, type, credit_limit, payment_terms, note, vat)
            VALUES ('$companyName', '$address', '$type', '$creditLimit', '$paymentTerms', '$note', '$vat')";
...
<body class="g-sidenav-show  bg-gray-200">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page"> <a href="../../../pages/dashboards/customer_data.php" >Client</a> </li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">New Customer</h6>
                </nav>
                                                        ...
                                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                                            <div class="input-group input-group-dynamic">
                                                                <select class="form-control" name="type"
                                                                    id="companyType" required>
                                                                    <option>Select Company Type</option><br><br>
                                                        ...
                                                        <div class="col-12 mt-4">
                                                            <div class="input-group input-group-dynamic">
                                                                <input class="multisteps-form__textarea form-control"
                                                                    rows="5" name="note"
                                                                    placeholder="Say a somthing about this customer"></input>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="button-row d-flex mt-4">
                                                    <button class="btn bg-gradient-dark ms-auto mb-0" type="submit"
                                                            title="Send">Create</button>
                                                </div>
    ...
    if (document.getElementById('companyType')) {
        var element = document.getElementById('companyType');
