...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // SQL query to insert data into the brand table
    $sql = "INSERT INTO brand (brand) VALUES ('$brand')";

    if ($conn->query($sql) === TRUE) {
        $message = "New Brand inserted successfully.";

        // Log the addition of a new brand
        $logSql = "INSERT INTO log (user, task, date_time, other, serverity) VALUES (?, ?, NOW(), ?, ?)";
        $logStmt = $conn->prepare($logSql);
        
        // Assuming you have a user session variable, adjust this accordingly
        $user = $_SESSION['user'];
        $task = 'Add Brand';
        $other = 'Brand: ' . $brand;
        $severity = 1; // 1 for informational, adjust as needed
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page"> <a href="../../dashboards/brand.php">Brand</a> </li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">New Brand</h6>
                </nav>
