...
// Initialize variables to hold fetched data and form data
$cus_em_id = '';

// Check if a cus_em_id is provided via GET or POST
if (isset($_REQUEST['brand_id'])) {
    $cus_em_id = $_REQUEST['brand_id'];

    // Sanitize the input (to prevent SQL injection)
    $cus_em_id = mysqli_real_escape_string($conn, $cus_em_id);

    // Query to retrieve data based on cus_em_id
    $sql = "SELECT * FROM brand WHERE brand_id = $cus_em_id";
    ...
    if ($result && $result->num_rows > 0) {
        ...
        echo "No data found for this brand: $cus_em_id";
    }
} else {
    echo "brand_id not provided.";
}

// Check if the form is submitted for updating data
// Check if the form is submitted for updating data
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    // Check if the "cus_em_id" parameter exists in the POST data
    if (isset($_POST['brand_id'])) {
      $cus_em_id = $_POST['brand_id'];
  
      // Get data from the form
      $updatedCEName = isset($_POST['brand']) ? mysqli_real_escape_string($conn, $_POST['brand']) : '';
      
  
      // SQL query to update data in the table
      $updateQuery = "UPDATE brand SET
                      brand = '$updatedCEName'
                      WHERE brand_id = $cus_em_id";
  ...
  if ($conn->query($updateQuery) === TRUE) {
    ...
    $user = $_SESSION['user'];
        $task = 'Edit Brand';
        $other = $row['brand'].' to ' . $updatedCEName ;
    ...
    echo "Error updating record: " . $conn->error;
     ...
     // ... Previous code for the first update query ...
    }
                        ...
                        <ul class="nav ">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link text-white " data-bs-toggle="collapse" aria-expanded="false"
                                    href="#productsExample">
                                    <span class="sidenav-mini-icon"> C </span>
                                    <span class="sidenav-normal  ms-2  ps-1"> Category <b class="caret"></b></span>
                                </a>
                                <div class="collapse " id="productsExample">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Edit Brand</h6>
                </nav>
                                ...
                                <div class="card">
                                    ...
                                    <form class="multisteps-form__form" method="POST">
                                            ...
                                            <div class="multisteps-form__panel border-radius-xl bg-white js-active"
                                                ...
                                                <h5 class="font-weight-bolder mb-0">About Brand</h5>
                                                        ...
                                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                                            <div class="input-group input-group-dynamic">
                                                                ...
                                                                <input class="multisteps-form__input form-control"
                                                                    type="text" name="brand"  value="<?php echo isset($row['brand']) ? $row['brand'] : ''; ?>"/>
                                                            </div>
                                                            <input class="multisteps-form__input form-control" type="hidden" name="brand_id" value="<?php echo $cus_em_id; ?>"/>
                                                ...
                                                <div class="button-row d-flex mt-4">
                                                    <button class="btn bg-gradient-dark ms-auto mb-0 js-btn-next"
                                                        type="submit" title="Next">Update</button>
                                                </div>
