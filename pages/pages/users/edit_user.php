...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM system_user WHERE id = $user_id";
    $result = $conn->query($sql);

    if ($result->num_rows == 1) {
        $row = $result->fetch_assoc();
        // Now, $row contains the user data for the specified user ID
    } else {
        echo "User not found";
                            ...
                            <div class="col-12 col-lg-8 m-auto">
                                <div class="card">
                                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                        <div class="bg-dark shadow-darkborder-radius-lg pt-4 pb-3">
                                    ...
                                    <div class="card-body">
                                        <form class="multisteps-form__form" method="POST">
                                            ...
                                            <div class="multisteps-form__panel border-radius-xl bg-white js-active"
                                                ...
                                                <h5 class="font-weight-bolder mb-0">Edit User Data</h5>
                                                        ...
                                                        <div class="col-12 ">
                                                            <div class="input-group input-group-dynamic">
                                                                <input class="multisteps-form__textarea form-control"
                                                                    ...
                                                                    value="<?php echo $row['notes']; ?>"></input>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="button-row d-flex mt-4">
