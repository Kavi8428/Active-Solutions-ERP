...
if (!$conn) {
  die('Database connection failed: ' . mysqli_connect_error());
...
else{// SQL query to fetch customer data

    if (isset($_GET['code'])) {
        $id = $_GET['code'];
    
    $query = "SELECT * FROM pricing WHERE item_code='$id'";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "UPDATE pricing SET lr='$lr', r='$r', rt='$rt', cost='$cost' WHERE item_code='$item_code'";
                                                    ...
                                                    <div class="col-6">
                                                        <div class="input-group input-group-dynamic">
                                                                        ...
                                                                        <input class="multisteps-form__input form-control"
                                                                            type="text" name="cost" value="<?php echo $item_code1;?>" />
                                                            </div>
                                                        ...
                                                        <div class="input-group input-group-dynamic">
                                                                        ...
                                                                        <input class="multisteps-form__input form-control"
                                                                            type="text" name="cost" value="<?php echo $cost;?>" />
                                                            </div>
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-4">
                                                            <div class="input-group input-group-dynamic">
                                                                        ...
                                                                        <input class="multisteps-form__input form-control"
                                                                            type="text" name="r" value="<?php echo $r;?>" />
                                                            </div>
                                                        </div>
                                                        <div class="col-4">
                                                            <div class="input-group input-group-dynamic">
                                                                        ...
                                                                        <input class="multisteps-form__input form-control"
                                                                            type="text" name="rt" value="<?php echo $rt;?>" />
                                                            </div>
                                                        </div>
                                                        <div class="col-4">
                                                        <div class="input-group input-group-dynamic">
                                                                        ...
                                                                        <input class="multisteps-form__input form-control"
                                                                            type="text" name="lr" value="<?php echo $lr;?>" />
                                                            </div>
