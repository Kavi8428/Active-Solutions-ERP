                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" style="color:black;" >
                                    ...
                                    <div class="row" style="margin:10px; font-size: small; ">
                                        <div id="letterhead" class="row">
                                            ...
                                            <span style="text-align: right; font-size: small; color:black; " class="col-6 ">
                                                ...
                                                E-mail: vipsupport@activelk.com <br>
                                            ...
                                            <div>
                                                <?php
                                                    if (isset($_GET['code'])) {
                                                        ...
                                                        $qt_product = "SELECT * FROM quotation_products WHERE deal_id = $id";
                                                        $result = $conn->query($qt_product);

                                                        if ($result->num_rows > 0) {
                                                            $checked_sum = 0; // Initialize checked_sum
                                                            

                                                            echo '<table style="color: black;" class=" col-12">';
                                                            echo '<thead >';
                                                            echo '<tr style="color:white;" class="row bg-dark  p-1 ">';
                                                            echo '<th class="col-2  text-start ">MODEL</th>';
                                                            echo '<th class="col-4  text-start ">DESCRIPTION</th>';
                                                            echo '<th class="col-2  text-center ">RATE</th>';
                                                            echo '<th class="col-1  text-center ">QTY</th>';
                                                            echo '<th class="col-2  text-center ">AMOUNT</th>';
                                                            echo '<th class="col-1  text-center ">VAT</th>';
                                                            echo '</tr>';
                                                            echo '</thead>';
                                                            echo '<tbody  >';
                                                           $totalRait = 0;
                                                           ...
                                                           $totalQt=0;
                                                            ...
                                                            while ($p_row = $result->fetch_assoc()) {
                                                                ...
                                                                $price = $p_row["price"];
                                                                $total = $p_row["total"];
                                                                $vatPercentatge = $p_row["vat"];
                                                                

                                                                // Increment checked_sum with each total value
                                                                $checked_sum += $total;
                                                                $priceTotal= $price*$quantity;
                                                                $vat = $total-$priceTotal;
                                                                $totalRait = $totalRait+$price;
                                                                $subTotal = $subTotal+$priceTotal;
                                                                
                                                                $totalQt += $quantity;
                                                                $vatTotal = ($vatPercentatge/100) * $priceTotal;
                                                                $vatDiscount = ($vatPercentatge/100)* $discount;
                                                                $totalVat += $vatTotal ;


                                                                
                                                                echo '<tr class="row   border-start border-end border-bottom ">';
                                                                echo '<td class="col-2 pt-1 text-start  border-start border-end border-bottom ">'.$itemCode.'</td>';
                                                                echo '<td class="col-4 pt-1  text-start  border-start border-end border-bottom ">' . $description . '</td>';
                                                                echo '<td class="col-2 pt-1  text-end  border-start border-end border-bottom ">' .number_format($price,2)  . '</td>';
                                                                echo '<td class="col-1 pt-1  text-center  border-start border-end border-bottom ">' . $quantity . '&nbsp;&nbsp;</td>';
                                                                echo '<td class="col-2 pt-1  text-end  border-start border-end border-bottom">' .  number_format($priceTotal,2) . '</td>';
                                                                echo '<td class="col-1 pt-1  text-center   border-start border-end border-bottom">' .$vatPercentatge. '%</td>';
                                                                //echo '<td class="col-2 pt-1  text-center ">' .  number_format($total,2) . '</td>';
                                                                echo '</tr>';


                                                               /* echo '<tr style="background: #CED7E8; height: 43px; "  class="row border-1 border-dark pt-1 ">';
                                                                echo '<td class="col-1 pt-2">';
                                                                echo '<label style="color: black;"> <b> TOTAL <b/></label>';
                                                                echo '</td>';
                                                                echo '<td class="col-4 pt-2  text-center "></td>';
                                                                echo '<td class="col-1 pt-2  text-start "></td>';
                                                                echo '<td class="col-1 pt-2  text-end ">'.$totalQt.'&nbsp;&nbsp;&nbsp;</td>';
                                                                echo '<td class="col-2 pt-2  text-center"><b>' .  number_format($subTotal,2) . '</b></td>';
                                                                echo '<td style="width:80px;" class="col-1 pt-2  text-center "><b>' . number_format ($totalVat,2) . '</b></td>';
                                                                echo '<td class="col-2 text-center ps-2 pt-2 "><b> ' . number_format ($checked_sum1,2) .'</b>';
                                                                echo '</td>';
                                                                echo '</tr>';*/
                                                                
                                                            }
                                                            $checked_sum0 = 0;
                                                            $qt_product0 = "SELECT * FROM quotation_products WHERE deal_id = $id AND checking = 0";
                                                            $result0 = $conn->query($qt_product0);
                                                            if ($result0->num_rows > 0) {
                                                                 // Initialize checked_sum
                                                                
                                                                while ($p_row0 = $result0->fetch_assoc()) {
                                                                    $vat = $p_row0["vat"];
                                                                    $total0 = $p_row0["total"];
                                                                    $checked_sum0 += $total0;
                                                                ...
                                                                $checked_sum1 = $checked_sum + $checked_sum0 ;
                                                                $formatted_checked_sum1 = number_format($checked_sum1);
                                                            ...
                                                            echo '</tbody>';
                                                            echo '<tr class="row ">';
                                                            echo '<td class="col-6 pt-2"></td>';
                                                            echo '<td class="col-2 pt-2  text-start border-start border-end border-bottom"><b>SUBTOTAL</b></td>';
                                                            echo '<td class="col-1 pt-2  text-start border-end border-bottom"></td>';
                                                            echo '<td class="col-2 pt-2  text-end border-end border-bottom"><b>' .  number_format($subTotal,2) . '</b></td>';
                                                            echo '<td class="col-1 text-start ps-2 pt-2 "></td>';
                                                            echo '</tr>';
                                                            
                                                            
                                                            echo '<tr class="row">';
                                                            echo '<td class="col-6 pt-2">'.$comment.'</td>';
                                                            echo '<td class="col-2 pt-2  text-start border-start border-end border-bottom">DISCOUNT</td>';
                                                            echo '<td class="col-1 pt-2  text-start border-end border-bottom"></td>';
                                                            echo '<td class="col-2 pt-2  text-end border-end border-bottom">' .  number_format($discount,2) . '</td>';
                                                            echo '<td class="col-1 text-start ps-2 pt-2 "></td>';
                                                            echo '</tr>';
                                                            $discountedTotal = $subTotal-$discount;
                                                            $finalVat = $totalVat-$vatDiscount;
                                                            echo '<tr class="row ">';
                                                            echo '<td class="col-6 pt-2"></td>';
                                                            echo '<td class="col-2 pt-2  text-start border-start border-end border-bottom">VAT</td>';
                                                            echo '<td class="col-1 pt-2  text-start border-end border-bottom"></td>';
                                                            echo '<td class="col-2 pt-2  text-end border-end border-bottom">' .  number_format($finalVat,2) . '</td>';
                                                            echo '<td class="col-1 text-start ps-2 pt-2 "></td>';
                                                            echo '</tr>';
                                                            $finalTotal = $subTotal - $discount +$finalVat;
                                                            echo '<tr class="row">';
                                                            echo '<td class="col-6 pt-2"></td>';
                                                            echo '<td class="col-2 pt-2  text-start border-start border-end border-bottom"><b>TOTAL</b></td>';
                                                            echo '<td class="col-1 pt-2  text-start border-end border-bottom"></td>';
                                                            echo '<td class="col-2 pt-2  text-end border-end border-bottom"><b>' .  number_format($finalTotal,2) . '</b></td>';
                                                            echo '<td class="col-1 text-start ps-2 pt-2 "></td>';
                                                            echo '</tr>';
                                                            echo '</table>';
                                                        } else {
                                                            echo "No records found for deal_id = $id and checking = 1.";
                                                        }
                                                    }
                                                ?>
                                                <script>
                                                    ...
                                                    const userName = <?php echo $_SESSION['user']?>
                                                      ...
                                                      document.addEventListener("DOMContentLoaded", function() {
                                                        ...
                                                        function updateVAT() {
                                                            ...
                                                            vatInput.value = vatValue.toLocaleString('en-US', { minimumFractionDigits: 0, maximumFractionDigits: 0 }) + ' /=';
                                                        ...
                                                        function updateGrandTotal() {
                                                            ...
                                                            grandTotalInput.value = grandTotalValue.toLocaleString('en-US', { minimumFractionDigits: 0, maximumFractionDigits: 0 }) + ' /=';
                                                        }
                                        ...
                                        <div <?php if ($result->num_rows >= 4){echo 'style="page-break-before: always;"';}?>   class="page-break">
                                        <div class="grouped-content">
                                            <div class="row mt-3 ">
                                                <b><u  style="color: black;" >Terms & Conditions:</u></b> <br>
                                            <p style="font-size: 13px; color:black; font-weight: 400; line-height: 1.7; " >
                                            &diams; Payment	: -	All payment should be made by cheque drawn in favor of “Active Solutions”.</br>
                                            &diams; Validity	: -	<?php echo $validity;?> Days from the date of quotation. Prices are based on present exchange Dollar Rate. Prices are subject to change on Dollar fluctuation.<br>
                                            &diams; Warranty	: -	As specified in quote. Active Solutions will provide Support after expiry of a warrenty  at a minimal warranty and charge.<br>
                                ...
                                <div class="row">
                                    <div class="col-3"></div>
                                    <div class="col-3">
                                        <button class="btn bg-dark " id="buttonPDF" type="button" name="generate_pdf" <?php echo $print ?>><i
                                    ...
                                    <div class="col-3"> <button class="btn bg-dark" onclick="sendEmail()" type="button" <?php echo $print ?>><i class="fa fa-envelope" aria-hidden="true"></i> &nbsp; <label>Email</label></button></div>
                                    <div class="col-3"> <button class="btn bg-dark" onclick="approve()"  type="button" <?php echo $approve ?>><i class="fa fa-android " aria-hidden="true" ></i> &nbsp; <label>Approve</label></button></div>
...
function approve() {
    ...
    document.getElementById('buttonPDF').onclick = function () {
        ...
        var opt = {
            ...
            image: { type: 'jpeg', quality: 0.9 }, // Change type to 'jpeg' for better compression
            html2canvas: { scale: 3 }, // You may adjust the scale as needed
            jsPDF: {
                unit: 'mm',
                format: 'a4',
        ...
        html2pdf().from(element).set(opt).save().then(function() {
                // After PDF generation, show the email link
                document.getElementById('p_employee').style.display = 'inline';
            });
    }
</script>
