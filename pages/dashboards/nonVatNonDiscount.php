                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" style="color:black;" >
                                <div id="pdfCard">
                                    <div class="row" style="margin:10px; font-size: small; ">
                                        ...
                                        <div class="row">
                                                ...
                                                <div style="align-content: right; " class="col-2 mt-3 ">
                                            ...
                                            <div>
                                                <?php
                                                    if (isset($_GET['code'])) {
                                                        ...
                                                        $qt_product = "SELECT * FROM quotation_products WHERE deal_id = $id AND checking = 1";
                                                        ...
                                                        if ($result->num_rows > 0) {
                                                            ...
                                                            echo '<th class="col-5  text-start ">DESCRIPTION</th>';
                                                           ...
                                                           $totalQt=0;
                                                            ...
                                                            while ($p_row = $result->fetch_assoc()) {
                                                                ...
                                                                $vatPrice = $price * ( $vatPercentatge / 100 );
                                                                ...
                                                                echo '<td class="col-5 pt-1  text-start  border-start border-end border-bottom ">' . $description . '</td>';
                                                            ...
                                                            if ($result0->num_rows > 0) {
                                                                ...
                                                                echo "<script>console.log('checked_sum',$checked_sum)</script>";
                                                                echo "<script>console.log('checked_sum0',$checked_sum0)</script>";
                                                                echo "<script>console.log('formatted_checked_sum1',$formatted_checked_sum1)</script>";



                                                            echo '</tbody>';
                                                            echo '<tr class="row ">';
                                                            echo '<td class="col-7 pt-2"> '.$comment.' </td>';
                                                            ...
                                                            echo "<script>console.log('subTotal',$subTotal)</script>";
                                                            $subTotal= $subTotal+$totalVat;
                                                            $grandTotal = $subTotal + $checked_sum0;
                                                            ...
                                                            echo '<td class="col-1 pt-2  text-start border-end border-bottom"></td>';
                                                            echo '<td class="col-2 pt-2  text-end border-end border-bottom">' . number_format($totalVat,2) . '</td>';
                                                            echo '<td class="col-1 text-start ps-2 pt-2 "></td>';
                                                            echo '</tr>';*/
                                                            
                                                            echo '<tr class="row">';
                                                            echo '<td class="col-7 pt-2"></td>';
                                                            echo '<td class="col-2 pt-2  text-start border-start border-end border-bottom"><b>TOTAL</b></td>';
                                                            echo '<td class="col-1 pt-2  text-start border-end border-bottom"></td>';
                                                            echo '<td class="col-2 pt-2  text-end border-end border-bottom"><b>' .  number_format($grandTotal,2) . '</b></td>';
                                                            //echo '<td class="col-1 text-start ps-2 pt-2 "></td>';
                                                            echo '</tr>';
                                ...
                                <div class="row">
                                    <div class="col-3"> </div>
                                    <div class="col-3">
                                        <button class="btn bg-dark " id="buttonPDF" type="button" name="generate_pdf" <?php echo $approve ?>><i
