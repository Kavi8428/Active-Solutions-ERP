...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO pricing (item_code,lr,r,rt,cost)
            VALUES ('$item_code','$lr','$r','$rt','$cost')";
...
if ($conn->query($sql) === TRUE) {
    ...
    if (isset($_GET['message'])) {
        echo '<script>alert("' . urldecode($_GET['message']) . '");</script>'; 
    }
    
} else {
    echo '<script>alert("Something Wrong. Please contact a developer who develop this");</script>'; 
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page"> <a href="../../pages/dashboards/price_view.php">Price</a></li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">New Price</h6>
                </nav>
                                    ...
                                    <div class="card-body">
                                        <form class="multisteps-form__form" method="POST">
                                            ...
                                            <div class="multisteps-form__panel border-radius-xl bg-white js-active"
                                                ...
                                                <h5 class="font-weight-bolder mb-0">About Price</h5>
                                                ...
                                                <div class="multisteps-form__content">
                                                    <div class="row mt-3">
                                                        <?php
                                                            ...
                                                            // Query to fetch item_code from the product table
                                                            ...
                                                            if (mysqli_num_rows($result) > 0) {
                                                                echo '<div class="col-6 mt-3 mt-sm-0">';
                                                                echo '<div class="form-group">';
                                                                echo '<select id="choices-tags" class="form-control" name="item_code">';
                                                ...
                                                <div class="button-row d-flex mt-4">
                                                    <button class="btn bg-gradient-dark ms-auto mb-0 js-btn-next"
                                                        type="submit" title="Next">Create</button>
                                                </div>
