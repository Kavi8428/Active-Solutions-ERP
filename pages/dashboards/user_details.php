    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-4">
            <div style="height: 30px;" class="row">
                ...
                <div class="col-2">
                    <?php
                if ($_SESSION["user_level"] === "admin" || "manager") {
                  echo  '<a href="../pages/users/new-user.php">
                        <button class="btn btn-dark">New User</button>
                    </a>';
                } ?>
...
if ($result->num_rows > 0) {
    echo '<table class="table table-flush" id="datatable-search">';
    ...
    while ($row = $result->fetch_assoc()) {
        echo '<tr>';
        echo '<td class="text-sm font-weight-normal">' . $row["id"] . '</td>';
        echo '<td class="text-sm font-weight-normal">' . $row["user_name"] . '</td>';
        ...
        echo '<td class="text-sm font-weight-normal">
                ...
                '<a href="?backup=true&id=' . $row["id"] . '" class="btn">
                    <i class="material-icons text-secondary position-relative text-lg">backup</i>
                </a>' .
                '<a href="?delete=true&id=' . $row["id"] . '" onclick="return confirm(\'Are you sure you want to delete this data?\');" class="btn">
...
if (isset($_GET["id"]) && isset($_GET["backup"])) {
    $userId = $_GET["id"];

    $sql = "SELECT * FROM system_user WHERE id = ?";
    ...
    $sqlDelete = "DELETE FROM system_user WHERE id = ?";
