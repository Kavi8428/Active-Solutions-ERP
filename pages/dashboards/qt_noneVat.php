                            ...
                            <form method="POST" style="color:black;" >
                                <div id="pdfCard">
                                    <div class="row" style="margin:10px; font-size: small; ">
                                        ...
                                        <div class="row">
                                            <div class="col-10">
                                                <p style="font-size: 13px; color:black; font-weight: 400; line-height: 1.7; " class=" w-100" type="text">
                                                    ...
                                                    if (isset($_GET['code'])) {
                                                        ...
                                                        if ($result->num_rows > 0) {
                                                           ...
                                                           $totalQt=0;
                                                            ...
                                                            echo '<td class="col-1 pt-2  text-start border-end border-bottom"></td>';
                                                            echo '<td class="col-2 pt-2  text-end border-end border-bottom"><b>' .  number_format($discountedTotal+$totalVat,2) . '</b></td>';
                                                            echo '</tr>';
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3"> <button class="btn bg-dark"  type="submit" name="send_email" onclick="sendEmail()"  <?php echo $print ?>><i class="fa fa-envelope" aria-hidden="true"></i> &nbsp; <label>Email</label></button></div>
                                    <div class="col-2"> <button class="btn bg-dark" onclick="approve()"  type="button" <?php echo $approve ?>><i class="fa fa-android " aria-hidden="true" ></i> &nbsp; <label>Approve</label></button></div>
                                </div>
                            </form>
                        </div>
                    </div>
