    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Category Details</h6>
                </nav>
        ...
        <div class="container-fluid py-4">
            <div style="height: 40px;" class="row">
                ...
                <div class="col-2">
                    <a href="../pages/account/new_category.php">
...
while ($row = mysqli_fetch_assoc($result)) {
    echo '<tr>';
    echo '<td style="font-size:12px;">' . $row['category_id'] . '</td>';
    echo '<td style="font-size:12px;">' . $row['category'] . '</td>';
    echo '<td>';
    echo '<a href="../pages/account/edit_category.php?category_id=' . $row['category_id'] . '"><button class="btn">Edit</button></a>';
    echo '<a href="?delete=true&category_id=' . $row['category_id'] . '" onclick="return confirm(\'Are you sure you want to delete this data?\');"><button class="btn">Del</button></a>';
    echo '</td>';
    echo '</tr>';
}
...
if (isset($_GET['delete']) && isset($_GET['category_id'])) {
    $deleteCustomerId = $_GET['category_id'];

    // Use a prepared statement to prevent SQL injection
    $selectSql = "SELECT * FROM category WHERE category_id = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        logEvent($_SESSION['user'], 'Delete category', 'Category ID: ' . $row['category_id'], 1);

        // Create a backup file in .doc format
        $backupFileName = 'category_backup_' . date('Y-m-d_H-i-s') . '.doc';
        $backupFilePath = '../../assets/category_backup/' . $backupFileName;

        $backupContent = "Backup of Category Data\n";
        $backupContent .= "Category ID: " . $row['category_id'] . "\n";
        $backupContent .= "Category: " . $row['category'] . "\n";
        ...
        $deleteCustomerSql = "DELETE FROM category WHERE category_id = ?";
